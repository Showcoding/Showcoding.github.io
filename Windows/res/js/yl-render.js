    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("LZM's Windows", 'Hello，你好，欢迎来到 楚楚和敏敏的 小分站！<br/>个人主页：' + '<a style="color: white" target="_blank" href="https://blog.csdn.net/weixin_46345400?spm=1000.2115.3001.5343"> 我的CSDN </a><br />本网站 UI 由 ' + '<a style="color: white" target="_blank" href="https://ylui.yuri2.cn"> YLUI </a> 强力驱动<p>欢迎使用支付宝扫描二维码对作者进行捐赠~<br/><br/><img style="width: 100%" src="/medias/reward/alipay.jpg"/></p>');
            }, 1500)
          });
        }
